# Релиз: как мы опенсорсили form-библиотеку на 50+ компонентов
...
13. [Form Analytics: как найти, где пользователь бросает форму](13-analytics.md)

---

_Это двенадцатая статья из цикла «@letar/forms — от боли к декларативным формам». [Предыдущая: MCP](11-mcp-ai.md) | [Следующая: Analytics](13-analytics.md)._
