...
> Первая статья из цикла «@letar/forms — от боли к декларативным формам». 12 статей о том, как мы построили form-библиотеку на 40 компонентов, отделили вёрстку от логики и пришли к open-source.
...
4. **40 полей: от String до Schedule** — обзор всех field-компонентов
